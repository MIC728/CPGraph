...
def display_splash_screen(args: argparse.Namespace) -> None:
    ...
    ASCIIColors.white("    ├─ Entity Types Dim1: ", end="")
    ASCIIColors.yellow(f"{getattr(args, 'entity_types_dim1', 'UNKNOWN')}")
    ASCIIColors.white("    ├─ Entity Types Dim2: ", end="")
    ASCIIColors.yellow(f"{getattr(args, 'entity_types_dim2', 'UNKNOWN')}")
