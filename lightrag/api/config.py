...
def parse_args() -> argparse.Namespace:
    ...
    args.entity_types_dim1 = get_env_value("ENTITY_TYPES_DIM1", DEFAULT_ENTITY_TYPES_DIM1, list)
    args.entity_types_dim2 = get_env_value("ENTITY_TYPES_DIM2", DEFAULT_ENTITY_TYPES_DIM2, list)
