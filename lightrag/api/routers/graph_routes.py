...
class EntityCreateRequest(BaseModel):
    ...
    entity_data: Dict[str, Any] = Field(
        ...,
        description="Dictionary containing entity properties. Common fields include 'description', 'entity_type_dim1', and 'entity_type_dim2'.",
        examples=[
            {
                "description": "Electric vehicle manufacturer",
                "entity_type_dim1": "ORGANIZATION",
                "entity_type_dim2": "COMPANY",
            }
        ],
    )
    ...
    async def create_entity(request: EntityCreateRequest):
        ...
        Request Body:
            ...
            entity_data (dict): Entity properties including:
                ...
                - entity_type_dim1 (str): Category/type of the entity dimension 1 (e.g., PERSON, ORGANIZATION, LOCATION)
                - entity_type_dim2 (str): Category/type of the entity dimension 2 (e.g., COMPANY, PRODUCT, SERVICE)
