...
async def _edit_entity_impl(
    ...
    *,
    ...
    entity_type_dim1 = new_node_data.get("entity_type_dim1", "UNKNOWN")
    entity_type_dim2 = new_node_data.get("entity_type_dim2", "UNKNOWN")
    content = entity_name + "\n" + description
...
async def aedit_entity(
    ...
    Args:
        ...
        relationships_vdb: Vector database storage for relationships
        entity_name: Name of the entity to edit
        updated_data: Dictionary containing updated attributes, e.g. {"description": "new description", "entity_type_dim1": "new type", "entity_type_dim2": "new type"}
    ...
    Returns:
        Dictionary containing updated entity information and operation summary with the following structure:
        {
            ...
            "entity_type_dim1": str,      # Entity type dimension 1
            "entity_type_dim2": str,      # Entity type dimension 2
...
async def acreate_entity(
    ...
    Args:
        ...
        entity_data: Dictionary containing entity attributes, e.g. {"description": "description", "entity_type_dim1": "type", "entity_type_dim2": "type"}
        entity_chunks_storage: Optional KV storage for tracking chunks that reference this entity
        relation_chunks_storage: Optional KV storage for tracking chunks that reference relations
    ...
    async with get_storage_keyed_lock(
        ...
        try:
            ...
            node_data = {
                ...
                "entity_type_dim1": entity_data.get("entity_type_dim1", "UNKNOWN"),
                "entity_type_dim2": entity_data.get("entity_type_dim2", "UNKNOWN"),
            ...
            entity_type_dim1 = node_data.get("entity_type_dim1", "UNKNOWN")
            entity_type_dim2 = node_data.get("entity_type_dim2", "UNKNOWN")
            content = entity_name + "\n" + description
...
async def _merge_entities_impl(
    ...
    *,
    ...
    default_entity_merge_strategy = {
        ...
        "entity_type_dim1": "keep_first",
        "entity_type_dim2": "keep_first",
    ...
    entity_type_dim1 = merged_entity_data.get("entity_type_dim1", "UNKNOWN")
    entity_type_dim2 = merged_entity_data.get("entity_type_dim2", "UNKNOWN")
...
async def amerge_entities(
    ...
    Args:
        ...
        target_entity_data: Dictionary of specific values to set for the target entity,
            overriding any merged values, e.g. {"description": "custom description", "entity_type_dim1": "PERSON", "entity_type_dim2": "EMPLOYEE"}
