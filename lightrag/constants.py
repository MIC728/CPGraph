...
# 兼容性：保留原始的单维度类型定义
DEFAULT_ENTITY_TYPES = DEFAULT_ENTITY_TYPES_DIM1

# Default standardized relation schema types
# Separator for multiple relation tags
DEFAULT_RELATION_SCHEMA_TAG_SEP = ","
...
# Entity merge LLM evaluation configuration
DEFAULT_ENTITY_MERGE_TOPK = 5          # 单实体评估时检索的相似实体数量
DEFAULT_ENTITY_MERGE_MAX_ASYNC = 30    # LLM评估最大并发数（控制RPM在2000以内）
