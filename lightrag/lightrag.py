...
class LightRAG:
    ...
    addon_params: dict[str, Any] = field(
        default_factory=lambda: {
            ...
            "entity_types_dim1": get_env_value("ENTITY_TYPES_DIM1", DEFAULT_ENTITY_TYPES_DIM1, list),
            "entity_types_dim2": get_env_value("ENTITY_TYPES_DIM2", DEFAULT_ENTITY_TYPES_DIM2, list),
        }
    )
        ...
        try:
            ...
            data_for_vdb = {
                compute_mdhash_id(dp["entity_name"], prefix="ent-"): {
                    ...
                    "entity_type_dim1": dp.get("entity_type_dim1", "UNKNOWN"),
                    "entity_type_dim2": dp.get("entity_type_dim2", "UNKNOWN"),
    ...
    async def amerge_entities(
        ...
        Args:
            ...
            merge_strategy: Merge strategy configuration, e.g. {"description": "concatenate", "entity_type_dim1": "keep_first", "entity_type_dim2": "keep_first"}
